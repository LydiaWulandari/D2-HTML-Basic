(() => {
  ...
  const e = (() => {
    const e = () =>
      ...
      n = () =>
        null === localStorage.getItem('defaultProjects')
          ? []
          : JSON.parse(localStorage.getItem('defaultProjects')),
      a = (t) => localStorage.setItem('projects', JSON.stringify(t)),
      r = (t) => localStorage.setItem('defaultProjects', JSON.stringify(t)),
      o = (t, o) => {
        const i = o ? n() : e(),
          s = i[t].tasks;
    ...
    return (
      localStorage.getItem('defaultProjects') ||
      ...
      })(),
      {
        ...
        addTaskToProject: (t) => {
          const o = t.isProjectInbox,
            i = o ? n() : e(),
            s = i[t.projectId];
          (s.tasks = [...s.tasks, t]), o ? r(i) : a(i);
        },
        editTask: (t, o, i, s) => {
          const d = s.isProjectInbox,
            c = s.isProjectInbox,
            u = d ? n() : e(),
            l = s.projectId,
            m = u[l].tasks;
        ...
        getProjects: e,
        getTaskObj: (t) => {
          const a = 'true' === t.dataset.isProjectInbox,
            r = t.dataset.projectId,
            o = t.dataset.id;
  ...
  function n(t, e, n, a, r, o, i, s, d, c) {
    (this.id = t),
      ...
      (this.description = n),
      (this.dueDate = a),
      (this.formattedDueDate = r),
      (this.projectId = o),
      (this.priority = i),
      (this.isProjectInbox = s),
      (this.defaultProjectId = d),
      (this.defaultProjectTaskId = c);
  }
  const a = () => {
    ...
    o = () => {
      ...
      return (
        ...
        e.setAttribute('d', 'M0 0h24v24H0z'),
        o.setAttribute('x', '5'),
        o.setAttribute('y', '6'),
        o.setAttribute('fill', 'currentColor'),
        o.setAttribute('rx', '.5'),
        n.setAttribute('fill', 'currentColor'),
        n.setAttribute('d', 'M10 9h1v8h-1V9zm3 0h1v8h-1V9z'),
    ...
    i = () => {
      ...
      return (
        ...
        r.setAttribute('fill-rule', 'evenodd'),
        e.setAttribute('fill', 'currentColor'),
        e.setAttribute('d', 'M9.5 19h10a.5.5 0 110 1h-10a.5.5 0 110-1z'),
    ...
    s = () => {
      const t = document.createElementNS('http://www.w3.org/2000/svg', 'svg'),
        e = document.createElementNS('http://www.w3.org/2000/svg', 'path');
      return (
        t.classList.add('project-icon'),
        t.setAttribute('viewBox', '0 0 24 24'),
        e.setAttribute('d', 'M12 7a5 5 0 110 10 5 5 0 010-10z'),
        e.setAttribute('fill', 'currentColor'),
        t.appendChild(e),
        t
      );
      ...
      const t = () => {
        ...
        n = () => {
          ...
          for (let t = 0; t < e.length; t++)
            e[t].dataset.defaultProjectTaskId = t;
          for (let t = 0; t < n.length; t++)
            n[t].dataset.defaultProjectTaskId = t;
        },
        o = (a) => {
          const r = parseInt(a.dataset.projectId),
            o = parseInt(a.dataset.id),
      ...
      return {
        editTaskButton: (t, e, n) => {
          const r = s(t),
            i = n.name,
            d = n.description,
            c = n.formattedDueDate,
            u = n.priority,
            l = document.querySelector(
              `.task-button[data-id="${n.id}"] .task-button-task-name`
            ),
            m = document.querySelector(
              `.task-button[data-id="${n.id}"] .task-button-description-text`
            ),
            h = document.querySelector(
              `.task-button[data-id="${n.id}"] .task-button-due-date-text`
            ),
            g = null === m,
            f = null === h,
            p = 'true' === r.dataset.isProjectInbox;
                ...
                ((t, e) => {
                  const n = document.createElement('div'),
                    ...
                    r = document.querySelector(
                      `.task-button[data-id='${t.dataset.id}'] > .task-button-due-date`
                    ),
                    o = null !== r;
                  n.classList.add('task-button-description'),
                    a.classList.add('task-button-description-text'),
                    (a.textContent = e),
                    n.appendChild(a),
                    o ? t.insertBefore(n, r) : t.appendChild(n);
                })(r, d)
              : ((t) => {
                  document
                    .querySelector(
                      `.task-button[data-id="${t}"] .task-button-description`
                    )
                    .remove();
                })(t),
            c && !f
              ...
              : null !== c ||
                ...
                ((t) => {
                  document
                    .querySelector(
                      `.task-button[data-id="${t}"] .task-button-due-date`
                    )
                    .remove();
                })(t),
            c &&
              ...
              ((t, e) => {
                ...
                n.classList.add('task-button-due-date'),
                  r.classList.add('task-button-due-date-left'),
                  o.classList.add('calendar-icon'),
                  i.classList.add('task-button-due-date-text'),
                  (i.innerText = e),
                  r.append(o, i),
                  n.append(r),
                  t.appendChild(n);
              })(r, c),
            (r.dataset.priority = u);
        },
        getTaskButton: (e) => {
          const n = !e.dueDate,
            s = !e.description,
            ...
            b = r();
          if (
            (d.classList.add('task-button'),
            c.classList.add('task-button-top'),
            u.classList.add('task-button-top-left'),
            l.classList.add('task-button-top-right'),
            m.classList.add(
              'task-button-edit-button',
              'task-button-action-button'
            ),
            f.classList.add('task-button-checkbox-button-div'),
            p.classList.add('task-button-checkbox-button'),
            b.classList.add('task-button-checkbox-icon', 'project-icon'),
            g.classList.add('task-button-task-name'),
            (g.innerText = e.name),
            (d.dataset.projectId = e.projectId),
            (d.dataset.id = e.id),
            (d.dataset.isProjectInbox = e.isProjectInbox),
            (d.dataset.priority = e.priority),
            (d.dataset.defaultProjectId = e.defaultProjectId),
            (d.dataset.defaultProjectTaskId = e.defaultProjectTaskId),
            f.appendChild(p),
            p.appendChild(b),
            u.append(f, g),
            m.appendChild(h),
            ...
            ((t, e) => {
              e.addEventListener('click', () => {
                lt.addDataAttributesToModal(t),
                  lt.toggleModal(),
                  lt.addEditClass(),
                  lt.disableProjectSelector(),
                  lt.changeSubmitButtonText('Save'),
                  lt.addTaskDataToModal(t),
                  lt.enableSubmitButton();
              });
            })(d, m),
            n && s)
          )
          ...
          if (
            (v.classList.add('task-button-description'),
            w.classList.add('task-button-description-text'),
            (w.innerText = e.description),
            v.append(w),
            d.append(v),
            n)
          )
          ...
          return (
            y.classList.add('task-button-due-date'),
            k.classList.add('task-button-due-date-left'),
            S.classList.add('calendar-icon'),
            T.classList.add('task-button-due-date-text'),
            (T.innerText = e.formattedDueDate),
            k.append(S, T),
            y.append(k),
            d.append(y),
            t(),
        ...
        getTaskButtonFromId: s,
        updateTaskButtonIds: t,
        updateTaskButtonDefaultProjectTaskIds: n,
      };
    })();
  function c(t, e) {
    if (e.length < t)
  ...
  function q(t, e) {
    ...
    var n = e || {},
      ...
      o = null == r ? 1 : T(r),
      i = null == n.firstWeekContainsDate ? o : T(n.firstWeekContainsDate),
      s = I(t, e),
      d = new Date(0);
  ...
  const V = {
    ...
    k: function (t, e, n) {
      ...
      return (
        0 === a && (a = 24),
        'ko' === e ? n.ordinalNumber(a, { unit: 'hour' }) : A(a, e.length)
      );
    },
    m: function (t, e, n) {
      return 'mo' === e
    ...
    var p = K(f),
      ...
      w = a
        ...
        .map(function (n) {
          ...
          if (i)
            return (
              !r.useAdditionalWeekYearTokens && nt(n) && at(n, e, t),
              !r.useAdditionalDayOfYearTokens && et(n) && at(n, e, t),
              i(b, n, o.localize, v)
            );
          if (a.match(dt))
            throw new RangeError(
  ...
  const lt = (() => {
      const t = document.querySelector('.add-task-button'),
        a = document.querySelector('.add-task-modal'),
        r = document.querySelector('.add-task-modal-overlay '),
        o = document.querySelector('#add-task-form'),
        i = document.getElementById('task-name-input'),
        s = document.getElementById('task-description-input'),
        c = document.querySelector('.due-date-picker'),
        u = document.querySelector('.project-selector'),
        l = document.querySelector('.priority-selector'),
        m = document.querySelector('.selected-priority > svg'),
        ...
        p = document.querySelector('.add-task-submit-button'),
        ...
        v = (t, e) => {
          ...
          return (
            ...
            (n.text = t),
            (n.dataset.id = e),
            n.classList.add('project-selection-option'),
            n
          );
        },
        w = () => {
        ...
        P = () => {
          D(),
            ...
            (() => {
              const t = gt.getSelectedButton(),
                e = 'true' === t.dataset.isDefaultProject,
                n = t.dataset.projectId,
                a = document.querySelectorAll('.project-selection-option'),
                r = document.querySelector(
                  ".project-selector option[value='inbox']"
                );
              ((e ? r : a[n]).selected = 'selected'),
                (u.dataset.selectedProjectId = n),
                (u.dataset.isProjectDefault = e);
            })(),
            T(),
            (m.dataset.priority = '4');
        },
        L = () => !!i.value.trim(),
        E = () => {
          L() ? j() : C();
        ...
        M = () => {
          const t = x(),
            n = a.classList.contains('editing');
          if ((P(), n)) {
            const n = a.dataset.taskId,
              r = a.dataset.projectId,
              o = 'true' === a.dataset.isProjectInbox;
            return e.editTask(n, r, o, t), void d.editTaskButton(n, r, t);
          }
          const r = gt.getSelectedButton(),
            o = r.dataset.projectId,
            i = 'true' === r.dataset.isDefaultProject,
            s = t.isProjectInbox,
            c = o === t.projectId && i === s;
      ...
      return (
        u.addEventListener('input', () => {
          (() => {
            const t =
              'true' === u.options[u.selectedIndex].dataset.isProjectDefault;
            u.dataset.isProjectDefault = t;
          })(),
            (() => {
              const t = u.selectedIndex,
                e = t > 0 ? t - 1 : 0;
              u.dataset.selectedProjectId = e;
            })();
        }),
        (c.min = ct(new Date(), 'yyyy-MM-dd')),
        w(),
        {
          addEditClass: () => {
          ...
          addDataAttributesToModal: (t) => {
            (a.dataset.taskId = t.dataset.id),
              (a.dataset.projectId = t.dataset.projectId),
              (a.dataset.isProjectInbox = t.dataset.isProjectInbox);
          },
          ...
          getTaskModalData: x,
          removeEditClass: D,
          addProjectSelectorOption: (t) => {
            const n = e.getNewProjectId(),
              a = v(t, n);
            u.appendChild(a);
          },
          addTaskDataToModal: (t) => {
            ...
            (i.value = n.name),
              (s.value = n.description),
              (m.dataset.priority = n.priority);
            const a = n.priority - 1,
              r = g[a].firstElementChild.cloneNode(!0);
            S(r), (c.value = n.dueDate);
          },
          enableSubmitButton: j,
          loadProjectSelectorOptions: w,
          removeProjectSelectorOption: (t) => {
            const e = document.querySelector(
              `.project-selection-option[data-id="${t}"]`
            );
    ...
    mt = (() => {
      const t = document.querySelector('.editor'),
        n = document.querySelector('.home-button'),
        a = document.querySelector('.sidebar-button-inbox'),
        r = (e) => {
          0 === document.querySelectorAll('.task-button').length &&
            ((e) => {
              const n = ((t) => {
                const e =
                    'true' === t.dataset.isDefaultProject
                      ? t.dataset.tabName
                      : 'Project',
                  ...
                  i = document.createElement('p');
                n.classList.add('empty-state-container'),
                  a.classList.add('empty-state-image'),
                  r.classList.add('empty-state-text'),
                  o.classList.add('empty-state-heading'),
                  i.classList.add('empty-state-body'),
                  (a.src = {
        ...
        o = (e, n) => {
          (() => {
            ...
            gt.changeTabTitle(n),
            gt.removeSelectedButtonClass(),
            gt.addSelectedClassToButton(e),
            (() => {
              const e = (() => {
            ...
            ((t) => {
              const e = document.querySelector('.tab-heading'),
                n = ((t) => {
            ...
            (() => {
              ...
              a.setAttribute(
                ...
                e.classList.add('editor-add-task-button'),
                n.classList.add('editor-add-task-plus-icon'),
                r.classList.add('editor-add-task-text'),
                (r.textContent = 'Add task'),
                n.appendChild(a),
                e.append(n, r),
                t.append(e);
            })(),
            document
              .querySelector('.editor-add-task-button')
              .addEventListener('click', () => lt.toggleModal()),
            s(e),
            r(e);
        },
        i = (e) => {
          const n = d.getTaskButton(e),
            a = document.querySelector('.editor-add-task-button');
          t.insertBefore(n, a),
            null !== document.querySelector('.empty-state-container') &&
              document.querySelector('.empty-state-container').remove();
        },
        s = (t) => {
          const n = 'true' === t.dataset.isDefaultProject,
            a = parseInt(t.dataset.projectId),
      ...
      return (
        ...
        }),
        {
          ...
          removeSidebarVisibleClass: () =>
            t.classList.remove('is-sidebar-visible'),
          loadEmptyStateIfProjectEmpty: r,
        }
      );
    })(),
    ht = (() => {
      const t = document.querySelector('.menu-button > span'),
        e = () => document.querySelectorAll('.tooltip');
      return (
        (() => {
          const t = (() => {
              const t = e(),
          ...
          for (let e = 0; e < n; e++) {
            ...
            a.addEventListener('mousedown', () => {
              n.classList.remove('visible'),
                n.classList.contains('clicked') && n.classList.add('clicked');
            }),
              a.addEventListener('mouseover', () => {
                n.classList.contains('clicked') &&
                n.classList.containes('visible')
                  ? n.classList.remove('visible')
    ...
    gt = (() => {
      const t = document.querySelector('.sidebar'),
        e = document.querySelector('.sidebar-overlay'),
        n = document.querySelector('.editor'),
        a = document.querySelector('.projects-list-container'),
        r = () => {
          t.classList.add('is-visible'),
            mt.addSidebarVisibleClass(),
            ht.changeMenuTooltipTextClose();
        };
      return (
        (() => {
          ...
          for (const a of e)
            a.addEventListener('click', () => {
              t.classList.toggle('is-visible'),
                n.classList.toggle('is-sidebar-visible'),
                document
                  .querySelector('.sidebar-overlay')
                  .classList.toggle('is-visible'),
                t.classList.contains('is-visible')
                  ? ht.changeMenuTooltipTextClose()
                  : ht.changeMenuTooltipTextOpen();
            });
        })(),
        (() => {
        ...
        window.innerWidth > 750 && r(),
        window.addEventListener('resize', () => {
          const n = t.classList.contains('is-visible'),
            a = e.classList.contains('is-visible'),
            o = window.innerWidth;
          if (!a)
            return n && o <= 750
              ? (t.classList.remove('is-visible'),
                mt.removeSidebarVisibleClass(),
                void ht.changeMenuTooltipTextOpen())
              : void (!n && o > 750 && r());
        }),
        (() => {
          const t = document.querySelectorAll('.sidebar-button');
          for (const e of t)
            e.addEventListener('click', () => {
              d.updateTaskButtonIds(),
                d.updateTaskButtonDefaultProjectTaskIds();
            });
        })(),
        {
          ...
          selectDefaultTab: () => {
            const t = document.querySelector('.sidebar-button-inbox'),
              e = t.dataset.tabName;
        ...
        n = (t) => {
          const n = ((t, e) => {
            const n = document.createElement('button'),
              ...
              r = o();
            return (
              r.classList.add('delete-project-icon'),
              n.classList.add('project-button', 'sidebar-button', 'tab-link'),
              a.classList.add('project-name'),
              (n.dataset.tabName = e),
              (a.textContent = e),
              n.append(t, a, r),
              n
          ...
          ((t) => {
            ...
            ((t) => {
              const n = t.dataset.tabName,
                a = t.childNodes[2];
              t.addEventListener(
                'click',
                (e) => e.target === t && mt.changeContent(e.target, n)
              ),
                a.addEventListener('click', () => {
                  gt.selectDefaultTab();
                  ...
                  ((t) => {
                    ...
                    lt.removeProjectSelectorOption(n),
                    e.removeProject(n),
                    (() => {
                      const t = document.querySelectorAll('.project-button');
                      for (let e = 0; e < t.length; e++)
                        t[e].dataset.projectId = e;
                    })(),
                    lt.updateProjectSelectorIds(),
                    e.updateProjectIds(),
                    e.updateTaskProjectIds();
                });
            })(n);
        };
      return (
        ...
        mt.changeContent(t, t.dataset.tabName),
        { addProjectButton: n }
      );
    })();
  (() => {
    const n = document.querySelector('.add-project-button'),
      a = document.querySelector('.add-project-modal'),
      r = document.querySelector('#add-project-form'),
      o = document.querySelector('#project_name'),
      i = document.querySelector('.add-project-modal .cancel-button'),
      s = document.querySelector('.add-project-submit-button'),
      d = document.querySelector('.add-project-modal-overlay '),
      c = () => (s.disabled = !0),
      u = () => {
      ...
      l = () => {
        ...
        const i = document.querySelector(
          `.project-button[data-project-id="${a}"]`
        );
    ...
    document
      .querySelector('.reset-data-button')
